...
public class PacienteController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        rd = request.getRequestDispatcher("/view/cadastroPaciente.jsp");
        rd.forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (nome_user.isEmpty() || cpf_user.isEmpty() || autorizado_user.isEmpty() || senha_user.isEmpty() || itp_user == 0) {
            ...
            Paciente paciente = new Paciente(nome_user, cpf_user, senha_user, autorizado_user, itp_user);
            pacienteDAO pacienteDAO = new pacienteDAO();
